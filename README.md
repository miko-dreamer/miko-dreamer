# <img src="https://media.giphy.com/media/hvRJCLzdwOFfW/giphy.gif" width="35px"> Mikael Alemayhu Developer 
...
- 💻 **Backend:** Mastering **Java**, **C++**, and **PHP** for robust system logic.
- 🏗️ **Current Build:** **Student Grading System** (JavaFX & MySQL).
- 🌐 **Web:** Crafting interactive experiences with **HTML, CSS, and JS**.
- ⚙️ **Systems:** Exploring **Linux** environments and Git workflows.
...
#### 🎨 Design & Tools
<p align="left">
  <img src="https://skillicons.dev/icons?i=ps,figma,ai,vscode,github,linux,mysql,git&perline=8" />
</p>
